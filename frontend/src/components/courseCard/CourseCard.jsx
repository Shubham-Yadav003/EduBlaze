    ...
    return (
        <div className='course-card'>
            ...
            {isAuth ? (
                <>
                    {user && user.role !== "admin" ? (
                        <>
                            {(user.subscription.includes(course._id) || user.mainrole === "superadmin") ? (
                                <button
          ...
          <br/>
            ...
            {
                user && (user.mainrole === "superadmin" || course.createdBy === user.name) && <button className='common-btn2' onClick={()=>deleteHandler(course._id)} >Delete</button>
            }
